...
def conv1x1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
    return StdConv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        self.conv1 = StdConv2d(3, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
        ## END
